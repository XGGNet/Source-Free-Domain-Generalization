...
CUDA_VISIBLE_DEVICES=1 python cae_mean_pool.py data/PACS -d PACS -t C -a resnet50 --seed 0 --log logs/clip_domainbank_mean_resnet50/PACS_C &
CUDA_VISIBLE_DEVICES=1 python cae_mean_pool.py data/PACS -d PACS -t S -a resnet50 --seed 0 --log logs/clip_domainbank_mean_resnet50/PACS_S