...
class Terra(ImageList):
    """`Terra <http://hemanthdv.org/OfficeHome-Dataset/>`_ Dataset.
    ...
    image_list = {
        "38": "image_list/location_38.txt",
        "43": "image_list/location_43.txt",
        "46": "image_list/location_46.txt",
        "100": "image_list/location_100.txt",
    }
    CLASSES = ['coyote', 'dog', 'raccoon', 'opossum', 'bird', 'bobcat', 'squirrel', 'cat', 'rabbit', 'landscape']
    ...
    def __init__(self, root: str, task: str, download: Optional[bool] = False, **kwargs):
        ...
        super(Terra, self).__init__(root, Terra.CLASSES, data_list_file=data_list_file, **kwargs)
